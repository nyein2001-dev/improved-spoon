        ...
        <ul class="sidebar-menu">
            ...
            <li
                ...
                <a href="#" class="nav-link has-dropdown">
                    ...
                    <span>{{ __('admin.All Orders') }}</span>
                </a>

                <ul class="dropdown-menu">
                    <li class="{{ Route::is('admin.all-booking') || Route::is('admin.order-show') ? 'active' : '' }}">
                        <a href="" class="nav-link">{{ __('admin.All Orders') }}</a>
                    </li>

                    <li class="{{ Route::is('admin.pending-order') ? 'active' : '' }}">
                        <a href="" class="nav-link">
                            {{ __('admin.Pending Orders') }}
                        </a>
                    </li>

                    <li class="{{ Route::is('admin.complete-order') ? 'active' : '' }}">
                        <a href="" class="nav-link">
                            {{ __('admin.Complete Orders') }}
                        </a>
                    </li>
                </ul>
